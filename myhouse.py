...
class PokemonHouse(Map):
    ...
    def get_objects(self) -> list[tuple[MapObject, Coord]]:
       ...
       # Create a border of trees
        ...
        self.place(objects,'poke_sand_bottom_left', (26,2))
        self._add_tile_line(objects, 'poke_sand_left', start=(25, 2), end=(18, 2))
        self._add_tile_line(objects, 'poke_sand_right', start=(24, 3), end=(18, 3))
        self.place(objects, 'poke_sand', (25, 3))
        self.place(objects, 'poke_sand_top_left', (18, 2))
        self.place(objects, 'poke_sand_top_right', (18, 3))
        self.place(objects, 'poke_sand_top_right', (25, 26))
        self.place(objects, 'poke_sand_bottom_right', (26, 26))
        ...
        self.place(objects, 'poke_sand_top_left', (16, 24))
        self.place(objects, 'poke_sand_up', (16, 25))
        self.place(objects, 'poke_sand_top_right', (16, 26))
        self.place(objects, 'poke_sand', (17, 24))
        self.place(objects, 'poke_sand', (17, 25))
        self.place(objects, 'poke_sand_right', (17, 26))
        self.place(objects, 'poke_sand_bottom_right', (18, 26))
        ...
        self.place(objects, 'poke_sand_bottom_left', (18, 17))
        self._add_tile_line(objects, 'poke_sand_left', start=(17, 17), end=(7, 17))
        self._add_tile_line(objects, 'poke_sand', start=(17, 18), end=(7, 18))
        self._add_tile_line(objects, 'poke_sand_right', start=(16, 19), end=(7, 19))
        self.place(objects, 'poke_sand', (17, 19))
        self.place(objects, 'poke_sand_top_left', (6, 17))
        self.place(objects, 'poke_sand_top_right', (6, 19))
